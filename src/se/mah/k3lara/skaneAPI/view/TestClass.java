...
public class TestClass {
	...
	public static void main(String[] args) {
	   ...
	   System.out.println("// Stations when searching for stations containing \"Malm\"");
		ArrayList<Station> searchStations = new ArrayList<Station>(); // arrayList av alla stationer
		searchStations.addAll(Parser.getStationsFromURL("Malm")); // lägger till info om station i arrayList?
		for (Station s: searchStations){
			System.out.println(s.getStationName() +" number:" +s.getStationNbr()); // printar ut stationnamn och nummer från arraylisten skapad ovan.
		}
	}
}
